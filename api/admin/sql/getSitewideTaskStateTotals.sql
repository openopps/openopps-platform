...
where tasks.state <> 'archived' and (tasks.community_id is null or community.is_disabled = false) and (community.target_audience <> 2 or community.target_audience is null) [filter clause]
group by task_state;