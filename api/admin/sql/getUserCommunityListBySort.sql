with users as (
    select 
        id, government_uri, username, "createdAt", community_user.created_at as joined_date, community_user.disabled, is_manager, is_approver, agency_id, last_login, name,
