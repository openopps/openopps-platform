...
'FROM community JOIN task  ON community.community_id = task.community_id ' +
'where community.target_audience <> 2 and community.is_disabled = false and (task.state =\'open\' or (task.state = \'in progress\' and task.accepting_applicants)) '+
