require.config({
  ...
  paths: {
    ...
    'jquery.caret'              : '../../vendor/jquery-caret/dist/jquery.caret.min',
    ...
    'volunteer_edit_form_template' : '../apps/tasks/edit/templates/volunteer_edit_form_template.html',
    ...
    'update_name_template'      : '../apps/tasks/show/templates/update_name_template.html',
    ...
    'admin_task_view'           : '../apps/admin/views/admin_task_view',
    'admin_tag_template'        : '../apps/admin/templates/admin_tag_template.html',
    'admin_task_template'        : '../apps/admin/templates/admin_task_template.html',
