  ...
  updateApplication: function (e) {
    ...
    if (this.data.submittedAt !== null) {
      this.modalComponent = new ModalComponent({
        ...
        'your application and click <strong>Submit application</strong>. You must submit changes before '+ moment.tz(this.data.cycle.apply_end_date, 'America/New_York').format('MMMM DD, YYYY') +' at 11:59 p.m. EST.</li></ol>',
        primary: {
